  ...
  return (
    <div className="container my-24 mx-auto md:px-6">
      ...
      <section className="mb-32 text-center md:text-left">
        <div className="shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
      ...
      <section className="mb-32">
        ...
        <div className="flex flex-wrap items-center">
          <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-6 lg:mb-0 lg:w-5/12">
            ...
            >
              <img
                src="https://mdbcdn.b-cdn.net/img/new/textures/full/126.jpg"
                className="w-full"
                alt="projects"
              />
              <a href="#!">
